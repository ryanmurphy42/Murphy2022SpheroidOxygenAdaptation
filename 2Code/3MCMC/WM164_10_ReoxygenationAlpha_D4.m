...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM164\10ReoxygenationAlpha_D4', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM164\10ReoxygenationAlpha_D4']);
end
if ~exist('4Figures\3MCMC\WM164\10ReoxygenationAlpha_D4', 'dir')
    mkdir(['4Figures\3MCMC\WM164\10ReoxygenationAlpha_D4']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM164\10ReoxygenationAlpha_D4\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM164\10ReoxygenationAlpha_D4\'];

simulation_id = 'WM164_10_ReoxygenationAlpha_D4';
...
reoxygenation_alpha_data= load([filepath_load 'WM164_oxygenwasteanalysis_reoxyD4.mat']);
...
save([filepath_save 'WM164_10_ReoxygenationAlpha_D4' '.mat'],'-v7.3');
