...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM983b\2Hypoxia', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM983b\2Hypoxia']);
end
if ~exist('4Figures\3MCMC\WM983b\2Hypoxia', 'dir')
    mkdir(['4Figures\3MCMC\WM983b\2Hypoxia']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM983b\2Hypoxia\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM983b\2Hypoxia\'];

simulation_id = 'WM983b_02_HypoxiaGreenspan';
...
% remove outliers
WM983b_outer_tmp = load([filepath_load 'WM983b_confocal_scenario_2_outer.mat']);
WM983b_necrotic_tmp = load([filepath_load 'WM983b_confocal_scenario_2_necrotic.mat']);
WM983b_inhibited_tmp = load([filepath_load 'WM983b_confocal_scenario_2_inhibited.mat']);
...
close all
save([filepath_save 'MCMC_WM983b_02_HypoxiaGreenspan' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM983b_02_HypoxiaGreenspan' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM983b\Scenario_2_OIN_1.fig']);
