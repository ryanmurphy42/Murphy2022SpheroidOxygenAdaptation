...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM164\3DeoxygenationAlpha', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM164\3DeoxygenationAlpha']);
end
if ~exist('4Figures\3MCMC\WM164\3DeoxygenationAlpha', 'dir')
    mkdir(['4Figures\3MCMC\WM164\3DeoxygenationAlpha']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM164\3DeoxygenationAlpha\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM164\3DeoxygenationAlpha\'];

simulation_id = 'WM164_03_DeoxygenationAlpha';
...
deoxygenation_alpha_data= load([filepath_load 'WM164_oxygenwasteanalysis_deoxy.mat']);

data.xdata = deoxygenation_alpha_data.confocal_WM164.AllData.Day;
...
save([filepath_save 'WM164_03_DeoxygenationAlpha' '.mat'],'-v7.3');
