...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM164\5DeoxygenationAll', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM164\5DeoxygenationAll']);
end
if ~exist('4Figures\3MCMC\WM164\5DeoxygenationAll', 'dir')
    mkdir(['4Figures\3MCMC\WM164\5DeoxygenationAll']);
end


filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM164\5DeoxygenationAll\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM164\5DeoxygenationAll\'];

simulation_id = 'WM164_05_DeoxygenationAll';
...
% remove outliers
WM164_outer_tmp = load([filepath_load 'WM164_confocal_scenario_3_outer.mat']);
WM164_necrotic_tmp = load([filepath_load 'WM164_confocal_scenario_3_necrotic.mat']);
WM164_inhibited_tmp = load([filepath_load 'WM164_confocal_scenario_3_inhibited.mat']);
...
filepath_load_alpha = [newdir '\3MATLABsavefiles\3MCMC\WM164\3DeoxygenationAlpha\'];
filepath_load_Rd  = [newdir '\3MATLABsavefiles\3MCMC\WM164\4DeoxygenationRd\'];
...
load_alpha = load([filepath_load_alpha 'WM164_03_DeoxygenationAlpha.mat'],"-mat",'params_withnormalfit');
load_Rd = load([filepath_load_Rd 'WM164_04_DeoxygenationRd.mat'],"-mat",'params_withnormalfit');
...
close all
save([filepath_save 'MCMC_WM164_05_DeoxygenationAll' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM164_05_DeoxygenationAll' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM164\Scenario_3_OIN_1.fig']);
