...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\3DeoxygenationAlpha', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\3DeoxygenationAlpha']);
end
if ~exist('4Figures\3MCMC\WM793b\3DeoxygenationAlpha', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\3DeoxygenationAlpha']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\3DeoxygenationAlpha\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\3DeoxygenationAlpha\'];

simulation_id = 'WM793b_03_DeoxygenationAlpha';
...
deoxygenation_alpha_data= load([filepath_load 'WM793b_oxygenwasteanalysis_deoxy.mat']);

data.xdata = deoxygenation_alpha_data.confocal_WM793b.AllData.Day;
...
save([filepath_save 'WM793b_03_DeoxygenationAlpha' '.mat'],'-v7.3');
