%% 2022--Murphy et al--Growth ane adaptation mechanisms of tumour spheroids with time-dependent oxygen availability
% ReoxygenationAll
...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\9ReoxygenationAll', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\9ReoxygenationAll']);
end
if ~exist('4Figures\3MCMC\WM793b\9ReoxygenationAll', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\9ReoxygenationAll']);
end


filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\9ReoxygenationAll\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\9ReoxygenationAll\'];

simulation_id = 'WM793b_09_ReoxygenationAll';
...
% remove outliers
WM793b_outer_tmp = load([filepath_load 'WM793b_confocal_scenario_4_outer.mat']);
WM793b_necrotic_tmp = load([filepath_load 'WM793b_confocal_scenario_4_necrotic.mat']);
WM793b_inhibited_tmp = load([filepath_load 'WM793b_confocal_scenario_4_inhibited.mat']);
...
filepath_load_alpha = [newdir '\3MATLABsavefiles\3MCMC\WM793b\7ReoxygenationAlpha\'];
filepath_load_Rd  = [newdir '\3MATLABsavefiles\3MCMC\WM793b\8ReoxygenationRd\'];
...
load_alpha = load([filepath_load_alpha 'WM793b_07_ReoxygenationAlpha.mat'],"-mat",'params_withnormalfit');
load_Rd = load([filepath_load_Rd 'WM793b_08_ReoxygenationRd.mat'],"-mat",'params_withnormalfit');
...
close all
save([filepath_save 'MCMC_WM793b_09_ReoxygenationAll' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM793b_09_ReoxygenationAll' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM793b\Scenario_4_OIN_1.fig']);
