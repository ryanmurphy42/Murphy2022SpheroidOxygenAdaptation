...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\7ReoxygenationAlpha', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\7ReoxygenationAlpha']);
end
if ~exist('4Figures\3MCMC\WM793b\7ReoxygenationAlpha', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\7ReoxygenationAlpha']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\7ReoxygenationAlpha\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\7ReoxygenationAlpha\'];

simulation_id = 'WM793b_07_ReoxygenationAlpha';
...
reoxygenation_alpha_data= load([filepath_load 'WM793b_oxygenwasteanalysis_reoxy.mat']);
...
save([filepath_save 'WM793b_07_ReoxygenationAlpha' '.mat'],'-v7.3');
