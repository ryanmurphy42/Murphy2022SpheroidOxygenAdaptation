...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\10ReoxygenationAlpha_D4', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\10ReoxygenationAlpha_D4']);
end
if ~exist('4Figures\3MCMC\WM793b\10ReoxygenationAlpha_D4', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\10ReoxygenationAlpha_D4']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\10ReoxygenationAlpha_D4\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\10ReoxygenationAlpha_D4\'];

simulation_id = 'WM793b_10_ReoxygenationAlpha_D4';
...
reoxygenation_alpha_data= load([filepath_load 'WM793b_oxygenwasteanalysis_reoxyD4.mat']);

data.xdata = reoxygenation_alpha_data.confocal_WM793b.AllData.Day;
...
alpha_initial_time = data.ydata(logical(data.xdata<=t_s));
...
save([filepath_save 'WM793b_10_ReoxygenationAlpha_D4' '.mat'],'-v7.3');
