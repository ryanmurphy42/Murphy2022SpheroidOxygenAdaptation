...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\12ReoxygenationAllD4', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\12ReoxygenationAllD4']);
end
if ~exist('4Figures\3MCMC\WM793b\12ReoxygenationAllD4', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\12ReoxygenationAllD4']);
end


filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\12ReoxygenationAllD4\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\12ReoxygenationAllD4\'];

simulation_id = 'WM793b_12_DeoxygenationAllD4';
...
% remove outliers
WM793b_outer_tmp = load([filepath_load 'WM793b_confocal_scenario_5_outer.mat']);
WM793b_necrotic_tmp = load([filepath_load 'WM793b_confocal_scenario_5_necrotic.mat']);
WM793b_inhibited_tmp = load([filepath_load 'WM793b_confocal_scenario_5_inhibited.mat']);
...
filepath_load_alpha = [newdir '\3MATLABsavefiles\3MCMC\WM793b\10ReoxygenationAlpha_D4\'];
filepath_load_Rd  = [newdir '\3MATLABsavefiles\3MCMC\WM793b\11ReoxygenationRd_D4\'];
...
load_alpha = load([filepath_load_alpha 'WM793b_10_ReoxygenationAlpha_D4.mat'],"-mat",'params_withnormalfit');
load_Rd = load([filepath_load_Rd 'WM793b_11_ReoxygenationRd_D4.mat'],"-mat",'params_withnormalfit');
...
% select all outer radii data on the first day (and exclude outliers)
NecroticRadius_initial = WM793b_necrotic.Radius(logical((WM793b_necrotic.Outlier==0).*(WM793b_necrotic.Day==day_min)));
...
close all
save([filepath_save 'MCMC_WM793b_12_ReoxygenationAllD4' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM793b_12_ReoxygenationAllD4' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM793b\Scenario_5_OIN_1.fig']);
