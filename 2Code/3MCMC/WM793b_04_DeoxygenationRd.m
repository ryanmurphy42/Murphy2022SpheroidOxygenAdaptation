...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\4DeoxygenationRd', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\4DeoxygenationRd']);
end
if ~exist('4Figures\3MCMC\WM793b\4DeoxygenationRd', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\4DeoxygenationRd']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\4DeoxygenationRd\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\4DeoxygenationRd\'];

simulation_id = 'WM793b_04_DeoxygenationRd';
...
deoxygenation_Rd_data= load([filepath_load 'WM793b_oxygenwasteanalysis_deoxy.mat']);

data.xdata = deoxygenation_Rd_data.confocal_WM793b.AllData.Day(deoxygenation_Rd_data.Rd_vector>=0); % select all data and filter to valid data (i.e when Rd >=0)
...
save([filepath_save 'WM793b_04_DeoxygenationRd' '.mat'],'-v7.3');
