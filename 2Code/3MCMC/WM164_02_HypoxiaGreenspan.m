...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM164\2Hypoxia', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM164\2Hypoxia']);
end
if ~exist('4Figures\3MCMC\WM164\2Hypoxia', 'dir')
    mkdir(['4Figures\3MCMC\WM164\2Hypoxia']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM164\2Hypoxia\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM164\2Hypoxia\'];

simulation_id = 'WM164_02_HypoxiaGreenspan';
...
% remove outliers
WM164_outer_tmp = load([filepath_load 'WM164_confocal_scenario_2_outer.mat']);
WM164_necrotic_tmp = load([filepath_load 'WM164_confocal_scenario_2_necrotic.mat']);
WM164_inhibited_tmp = load([filepath_load 'WM164_confocal_scenario_2_inhibited.mat']);
...
theta_first_guess =  [Rd_normaldistribution_fit.mu + 1*Rd_normaldistribution_fit.sigma; % Rd
    0.1; % lambda
    0.1; % s
    Rc_normaldistribution_fit.mu+2*Rc_normaldistribution_fit.sigma;  % Rc
...
close all
save([filepath_save 'MCMC_WM164_02_HypoxiaGreenspan' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM164_02_HypoxiaGreenspan' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM164\Scenario_2_OIN_1.fig']);
