...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\8ReoxygenationRd', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\8ReoxygenationRd']);
end
if ~exist('4Figures\3MCMC\WM793b\8ReoxygenationRd', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\8ReoxygenationRd']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\8ReoxygenationRd\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\8ReoxygenationRd\'];

simulation_id = 'WM793b_08_ReoxygenationRd';
...
reoxygenation_Rd_data= load([filepath_load 'WM793b_oxygenwasteanalysis_reoxy.mat']);

data.xdata = reoxygenation_Rd_data.confocal_WM793b.AllData.Day(reoxygenation_Rd_data.Rd_vector>=0); % select all data and filter to valid data (i.e when Rd >=0)
...
save([filepath_save 'WM793b_08_ReoxygenationRd' '.mat'],'-v7.3');
