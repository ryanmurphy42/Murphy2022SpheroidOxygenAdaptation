...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM983b\5DeoxygenationAll', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM983b\5DeoxygenationAll']);
end
if ~exist('4Figures\3MCMC\WM983b\5DeoxygenationAll', 'dir')
    mkdir(['4Figures\3MCMC\WM983b\5DeoxygenationAll']);
end


filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM983b\5DeoxygenationAll\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM983b\5DeoxygenationAll\'];

simulation_id = 'WM983b_05_DeoxygenationAll';
...
close all
save([filepath_save 'MCMC_WM983b_05_DeoxygenationAll' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM983b_05_DeoxygenationAll' '.mat']);
