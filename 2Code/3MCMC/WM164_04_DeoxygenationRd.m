...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM164\4DeoxygenationRd', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM164\4DeoxygenationRd']);
end
if ~exist('4Figures\3MCMC\WM164\4DeoxygenationRd', 'dir')
    mkdir(['4Figures\3MCMC\WM164\4DeoxygenationRd']);
end

filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM164\4DeoxygenationRd\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM164\4DeoxygenationRd\'];

simulation_id = 'WM164_04_DeoxygenationRd';
...
deoxygenation_Rd_data= load([filepath_load 'WM164_oxygenwasteanalysis_deoxy.mat']);

data.xdata = deoxygenation_Rd_data.confocal_WM164.AllData.Day(deoxygenation_Rd_data.Rd_vector>=0); % select all data and filter to valid data (i.e when Rd >=0)
...
params = {
    {'Rd normoxia', p_mle(1), p_lower_bounds(1),p_upper_bounds(1)}
    {'Rd hypoxia', p_mle(2), p_lower_bounds(2),p_upper_bounds(2)}
...
save([filepath_save 'WM164_04_DeoxygenationRd' '.mat'],'-v7.3');
