...
% create folders
cd ../
if ~exist('3MATLABsavefiles\3MCMC\WM793b\1Normoxia', 'dir')
    mkdir(['3MATLABsavefiles\3MCMC\WM793b\1Normoxia']);
end
if ~exist('4Figures\3MCMC\WM793b\1Normoxia', 'dir')
    mkdir(['4Figures\3MCMC\WM793b\1Normoxia']);
end


filepath_save = [newdir '\3MATLABsavefiles\3MCMC\WM793b\1Normoxia\'];
filepath_save_figs =  [newdir '\4Figures\3MCMC\WM793b\1Normoxia\'];

simulation_id = 'WM793b_01_NormoxiaGreenspan';
...
% remove outliers
WM793b_outer_tmp = load([filepath_load 'WM793b_confocal_scenario_1_outer.mat']);
WM793b_necrotic_tmp = load([filepath_load 'WM793b_confocal_scenario_1_necrotic.mat']);
WM793b_inhibited_tmp = load([filepath_load 'WM793b_confocal_scenario_1_inhibited.mat']);
...
close all
save([filepath_save 'MCMC_WM793b_01_NormoxiaGreenspan' '.mat'],'-v7.3');
...
if include_plots == 1
    ...
    load([filepath_save 'MCMC_WM793b_01_NormoxiaGreenspan' '.mat']);
    ...
    fig_boxchart_predinterval = openfig([newdir '\4Figures\1FirstAnalysisExperimentalData\WM793b\Scenario_1_OIN_1.fig']);
