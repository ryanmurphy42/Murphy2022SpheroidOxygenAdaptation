%% Convert confocal WM983b data to .mat file and plot experimental data
% 0.1) Load data
...
confocal_WM983b.AllDatatmp = confocal.AllData(wm983b_data_include,:); % load WM983b data
confocal_WM983b.AllData = confocal_WM983b.AllDatatmp((confocal_WM983b.AllDatatmp.Keep==1),:); % only keep those that are not multiple spheroids or damaged spheroids
...
[scenario_1_plotdata.OuterRadius_to_plot,...
    ...
    confocal_WM983b.AllData.Condition,...
    confocal_WM983b.AllData.OuterRadius,...
    confocal_WM983b.AllData.InhibitedRadius,...
    confocal_WM983b.AllData.NecroticRadius,...
    confocal_WM983b.AllData.PIMOuterRadius,...
    confocal_WM983b.AllData.PIMInnerRadius,...
    confocal_WM983b.AllData.Day);
...
fname = confocal_WM983b.AllData.fname;
ExpID = confocal_WM983b.AllData.ExpID;
CellLine = confocal_WM983b.AllData.CellLine;
Condition = confocal_WM983b.AllData.Condition;
Day = confocal_WM983b.AllData.Day;
Replicate = confocal_WM983b.AllData.Replicate;
Radius = confocal_WM983b.AllData.OuterRadius;
Outlier = zeros(length(confocal_WM983b.AllData.OuterRadius),1);
...
save([filepath_save 'WM983b_confocal_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_1_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_2_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM983b.AllData.Day;
Replicate = confocal_WM983b.AllData.Replicate;
Radius = confocal_WM983b.AllData.InhibitedRadius;
Outlier = zeros(length(confocal_WM983b.AllData.InhibitedRadius),1);
...
save([filepath_save 'WM983b_confocal_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_1_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_2_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM983b.AllData.Day;
Replicate = confocal_WM983b.AllData.Replicate;
Radius = confocal_WM983b.AllData.NecroticRadius;
Outlier = zeros(length(confocal_WM983b.AllData.NecroticRadius),1);
...
save([filepath_save 'WM983b_confocal_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_1_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_2_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM983b.AllData.Day;
Replicate = confocal_WM983b.AllData.Replicate;
Radius = confocal_WM983b.AllData.PIMOuterRadius;
Outlier = zeros(length(confocal_WM983b.AllData.PIMOuterRadius),1);
...
save([filepath_save 'WM983b_confocal_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_1_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_2_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_3_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_3_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_3_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM983b_confocal_scenario_3_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
