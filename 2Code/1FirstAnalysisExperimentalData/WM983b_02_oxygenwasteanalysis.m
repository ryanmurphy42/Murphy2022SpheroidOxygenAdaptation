%% WM983B oxygen and waste analysis
...
confocal_WM983b.AllData = confocal_WM983b.AllDatatmp1(sum(confocal_WM983b.AllDatatmp1.Condition==[1,2,3,4,17,18,19,15,16],2)==1,:); % only include scenarios 1 and 2
...
filepath_save_figs =  [newdir '\4Figures\1FirstAnalysisExperimentalData\WM983b\'];
...
for i=1:number_of_spheroids
    ...
    if  sum(confocal_WM983b.AllData.Condition(i) == [1,2,3,4])> 0
        % Scenario 1
        scenario_colour_vec(i) = 0;
    elseif sum(confocal_WM983b.AllData.Condition(i) == [17,18,19,15,16]) > 0
        % Scenario 2
