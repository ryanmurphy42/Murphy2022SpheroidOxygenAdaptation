%% Convert confocal WM164 data to .mat file and plot experimental data
% 0.1) Load data
...
confocal_WM164.AllDatatmp = confocal.AllData(wm164_data_include,:); % load WM164 data
confocal_WM164.AllData = confocal_WM164.AllDatatmp((confocal_WM164.AllDatatmp.Keep==1),:); % only keep those that are not multiple spheroids or damaged spheroids
...
[scenario_1_plotdata.OuterRadius_to_plot,...
    ...
    confocal_WM164.AllData.Condition,...
    confocal_WM164.AllData.OuterRadius,...
    confocal_WM164.AllData.InhibitedRadius,...
    confocal_WM164.AllData.NecroticRadius,...
    confocal_WM164.AllData.PIMOuterRadius,...
    confocal_WM164.AllData.PIMInnerRadius,...
    confocal_WM164.AllData.Day);
...
fname = confocal_WM164.AllData.fname;
ExpID = confocal_WM164.AllData.ExpID;
CellLine = confocal_WM164.AllData.CellLine;
Condition = confocal_WM164.AllData.Condition;
Day = confocal_WM164.AllData.Day;
Replicate = confocal_WM164.AllData.Replicate;
Radius = confocal_WM164.AllData.OuterRadius;
Outlier = zeros(length(confocal_WM164.AllData.OuterRadius),1);
...
save([filepath_save 'WM164_confocal_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_1_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_2_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_3_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_4_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_5_outer' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM164.AllData.Day;
Replicate = confocal_WM164.AllData.Replicate;
Radius = confocal_WM164.AllData.InhibitedRadius;
Outlier = zeros(length(confocal_WM164.AllData.InhibitedRadius),1);
...
save([filepath_save 'WM164_confocal_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_1_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_2_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_3_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_4_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_5_inhibited' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM164.AllData.Day;
Replicate = confocal_WM164.AllData.Replicate;
Radius = confocal_WM164.AllData.NecroticRadius;
Outlier = zeros(length(confocal_WM164.AllData.NecroticRadius),1);
...
save([filepath_save 'WM164_confocal_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_1_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_2_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_3_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_4_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_5_necrotic' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
Day = confocal_WM164.AllData.Day;
Replicate = confocal_WM164.AllData.Replicate;
Radius = confocal_WM164.AllData.PIMOuterRadius;
Outlier = zeros(length(confocal_WM164.AllData.PIMOuterRadius),1);
...
save([filepath_save 'WM164_confocal_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_1_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_2_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_3_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_4_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
...
save([filepath_save 'WM164_confocal_scenario_5_PIMOuter' '.mat'],'-v7.3',...
    'fname',...
    'ExpID',...
    'CellLine',...
    'Condition',...
